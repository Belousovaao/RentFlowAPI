...
namespace RentFlow.Persistance.Migrations
{
    ...
    [Migration("20260316042203_SnapshotNew2")]
    partial class SnapshotNew2
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("RentFlow.Domain.Bookings.Snapshots.BookingCustomerSnapshot", "CustomerSnapshot", b1 =>
                        {
                            ...
                            b1.OwnsOne("RentFlow.Domain.Bookings.BookingEntrepreneurSnapshot", "Entrepreneur", b2 =>
                                {
                                    ...
                                    b2.Property<string>("FactAdress")
                                        .IsRequired()
                                        .HasColumnType("text");

                                    b2.Property<string>("OrganizationAdress")
                                        .IsRequired()
                                        .HasColumnType("text");
                                    ...
                                    b2.OwnsOne("RentFlow.Domain.Customers.BankAccount", "IPBankAccount", b3 =>
                                        {
                                            b3.Property<Guid>("BookingEntrepreneurSnapshotBookingCustomerSnapshotBookingId")
                                                .HasColumnType("uuid");

                                            b3.Property<string>("BIK")
                                                .HasColumnType("text");

                                            b3.Property<string>("BankName")
                                                .HasColumnType("text");

                                            b3.Property<string>("CorrespondentAccount")
                                                .HasColumnType("text");

                                            b3.Property<string>("CurrentAccount")
                                                .HasColumnType("text");

                                            b3.HasKey("BookingEntrepreneurSnapshotBookingCustomerSnapshotBookingId");

                                            b3.ToTable("Bookings");

                                            b3.WithOwner()
                                                .HasForeignKey("BookingEntrepreneurSnapshotBookingCustomerSnapshotBookingId");
                                        });

                                    b2.OwnsOne("RentFlow.Domain.Customers.PersonName", "Name", b3 =>
                                        {
                                            b3.Property<Guid>("BookingEntrepreneurSnapshotBookingCustomerSnapshotBookingId")
                                                .HasColumnType("uuid");
                            ...
                            b1.OwnsOne("RentFlow.Domain.Bookings.BookingIndividualSnapshot", "Individual", b2 =>
                                {
                                    b2.Property<Guid>("BookingCustomerSnapshotBookingId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.OwnsOne("RentFlow.Domain.Customers.PersonName", "Name", b3 =>
                                        {
                                            b3.Property<Guid>("BookingIndividualSnapshotBookingCustomerSnapshotBookingId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("BookingIndividualSnapshotBookingCustomerSnapshotBookingId");

                                            b3.ToTable("Bookings");

                                            b3.WithOwner()
                                                .HasForeignKey("BookingIndividualSnapshotBookingCustomerSnapshotBookingId");
                                        });

                                    b2.OwnsOne("RentFlow.Domain.Customers.Passport", "Passport", b3 =>
                                        {
                                            b3.Property<Guid>("BookingIndividualSnapshotBookingCustomerSnapshotBookingId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.Property<DateOnly?>("IssuedDate")
                                                .HasColumnType("date");
                                            ...
                                            b3.Property<string>("RegistrationAddress")
                                                .HasColumnType("text");
                                    ...
                                    b2.Navigation("Passport")
                                        .IsRequired();
                                });

                            b1.OwnsOne("RentFlow.Domain.Bookings.BookingOrganizationSnapshot", "Organization", b2 =>
                                {
                                    b2.Property<Guid>("BookingCustomerSnapshotBookingId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.OwnsOne("RentFlow.Domain.Customers.BankAccount", "BankAccount", b3 =>
                                        {
                                            b3.Property<Guid>("BookingOrganizationSnapshotBookingCustomerSnapshotBookingId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("BookingOrganizationSnapshotBookingCustomerSnapshotBookingId");

                                            b3.ToTable("Bookings");

                                            b3.WithOwner()
                                                .HasForeignKey("BookingOrganizationSnapshotBookingCustomerSnapshotBookingId");
                                        });

                                    b2.Navigation("BankAccount")
                                        .IsRequired();
                                });

                            b1.Navigation("Entrepreneur");

                            b1.Navigation("Individual");
