...
namespace RentFlow.Persistance.Migrations
{
    ...
    [Migration("20260311035239_AddedSnapshotsForName")]
    partial class AddedSnapshotsForName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentFlow.Domain.Bookings.BookingEntrepreneurSnapshot", b =>
                {
                    b.OwnsOne("RentFlow.Domain.Customers.PersonName", "Name", b1 =>
                        {
                            b1.Property<Guid>("BookingEntrepreneurSnapshotId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BookingEntrepreneurSnapshotId");

                            b1.ToTable("BookingCustomerSnapshot");

                            b1.WithOwner()
                                .HasForeignKey("BookingEntrepreneurSnapshotId");
                        });
            ...
            modelBuilder.Entity("RentFlow.Domain.Bookings.BookingIndividualSnapshot", b =>
                {
                    b.OwnsOne("RentFlow.Domain.Customers.PersonName", "Name", b1 =>
                        {
                            b1.Property<Guid>("BookingIndividualSnapshotId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BookingIndividualSnapshotId");

                            b1.ToTable("BookingCustomerSnapshot");

                            b1.WithOwner()
                                .HasForeignKey("BookingIndividualSnapshotId");
                        });
