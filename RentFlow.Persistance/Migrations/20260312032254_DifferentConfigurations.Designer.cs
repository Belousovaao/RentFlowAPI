...
namespace RentFlow.Persistance.Migrations
{
    ...
    [Migration("20260312032254_DifferentConfigurations")]
    partial class DifferentConfigurations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentFlow.Domain.Bookings.BookingEntrepreneurSnapshot", b =>
                {
                    ...
                    b.ToTable("BookingCustomerSnapshot", t =>
                        {
                            t.Property("Email")
                                .HasColumnName("BookingEntrepreneurSnapshot_Email");

                            t.Property("FactAdress")
                                .HasColumnName("BookingEntrepreneurSnapshot_FactAdress");

                            t.Property("OrganizationAdress")
                                .HasColumnName("BookingEntrepreneurSnapshot_OrganizationAdress");

                            t.Property("Phone")
                                .HasColumnName("BookingEntrepreneurSnapshot_Phone");
                        });
            ...
            modelBuilder.Entity("RentFlow.Domain.Bookings.BookingEntrepreneurSnapshot", b =>
                {
                    b.OwnsOne("RentFlow.Domain.Customers.BankAccount", "IPBankAccount", b1 =>
                        {
                            b1.Property<Guid>("BookingEntrepreneurSnapshotBookingId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BookingEntrepreneurSnapshotBookingId");

                            b1.ToTable("BookingCustomerSnapshot");

                            b1.WithOwner()
                                .HasForeignKey("BookingEntrepreneurSnapshotBookingId");
                        });
            ...
            modelBuilder.Entity("RentFlow.Domain.Bookings.BookingIndividualSnapshot", b =>
                {
                    b.OwnsOne("RentFlow.Domain.Customers.PersonName", "Name", b1 =>
                        {
                            b1.Property<Guid>("BookingIndividualSnapshotBookingId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BookingIndividualSnapshotBookingId");

                            b1.ToTable("BookingCustomerSnapshot");

                            b1.WithOwner()
                                .HasForeignKey("BookingIndividualSnapshotBookingId");
                        });

                    b.OwnsOne("RentFlow.Domain.Customers.Passport", "Passport", b1 =>
                        {
                            b1.Property<Guid>("BookingIndividualSnapshotBookingId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RentFlow.Domain.Bookings.BookingOrganizationSnapshot", b =>
                {
                    b.OwnsOne("RentFlow.Domain.Customers.BankAccount", "BankAccount", b1 =>
                        {
                            b1.Property<Guid>("BookingOrganizationSnapshotBookingId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BookingOrganizationSnapshotBookingId");

                            b1.ToTable("BookingCustomerSnapshot");

                            b1.WithOwner()
                                .HasForeignKey("BookingOrganizationSnapshotBookingId");
                        });
